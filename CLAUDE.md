...
│   │   └── cron.js           ← node-cron: 24hr reminders, onboarding nudge, SMS setup drip (hourly :30), pre-appt confirmation SMS (7:30am daily), review request SMS (hourly :50), post-job close tracking SMS (hourly :45), 72hr silence alert (every 6h), Twilio pool "gone dark" sweep (daily 2am)
│   ├── middleware/

...
- **GBP/Messenger self-serve walkthrough** — as a fresh contractor, follow the AI's copy-paste instructions for the GBP booking button and Messenger/Instagram auto-reply end to end, checking nothing assumes prior platform knowledge. **Still open.**
- **STOP mid-session** — reply STOP partway through an active Brain 3 conversation and confirm Twilio's native opt-out doesn't leave the session in a weird half-state. **Still open.**

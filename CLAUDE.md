...
Tabs: Leads | Contractors | Appointments | Performance | API Keys | Niches | Waitlist (added session 26 — lists every waitlist signup with a one-tap Promote action that creates the real contractor account via the same flow the intake form uses)

...
router.post('/admin/register', (req, res) => {
  ...
  db.prepare('INSERT INTO admins (id, email, password_hash, name) VALUES (?, ?, ?, ?)').run(id, email, hash, name);
...
router.post('/contractor/login', (req, res) => {
  ...
  const contractor = db.prepare('SELECT * FROM contractors WHERE email = ?').get(email);

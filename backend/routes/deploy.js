...
router.post('/', requireDeploySecret, async (req, res) => {
  ...
  log(`DEBUG fields — emergency:${data.emergency} warranty:${data.warranty} warrantyYears:${data.warrantyYears} financing:${data.financing} financingFrom:${data.financingFrom} nate:${data.nate} commercial:${data.commercial} years:${data.years}`);

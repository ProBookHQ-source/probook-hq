      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        {tab === 'setup' && (
          <div className="flex-1 flex flex-col md:flex-row overflow-hidden pb-16 md:pb-0">
              ...
              {/* Tractify handles the rest */}
              <div className="mt-6 px-5 py-4 bg-gray-50 rounded-2xl border border-gray-100 text-center">
                <p className="text-sm text-gray-400 leading-relaxed">
                  Everything else is handled by Tractify — you'll get a text as each channel goes live.
                </p>
              </div>

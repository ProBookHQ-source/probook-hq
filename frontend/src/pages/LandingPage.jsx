      ...
      <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 sm:h-16 flex items-center justify-between gap-3">
          <div className="flex items-center gap-2 shrink-0">
            ...
            <span className="font-bold text-gray-900 text-base sm:text-lg">ProBook</span>
          </div>
      ...
      <section className="py-14 md:py-24 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-5 sm:mb-6">Why homeowners choose ProBook</h2>
      ...
      <section className="py-14 md:py-24 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 sm:mb-12">
            ...
            <p className="text-gray-500 text-sm sm:text-base max-w-xl mx-auto">Join ProBook and get qualified leads delivered straight to your calendar — no cold calling, no chasing.</p>
          </div>
